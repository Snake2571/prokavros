...
public class AuthorizationRequest extends StringRequest {
    ...
    public static AuthorizationRequest requestLogin(String login, String password, final PostResponseListener listener/* Response.Listener<String> listener, Response.ErrorListener errorListener*/ ) {
