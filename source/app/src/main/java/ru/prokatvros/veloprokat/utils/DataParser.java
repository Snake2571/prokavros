...
import ru.prokatvros.veloprokat.utils.SQLiteDBWork;
...
public class DataParser {
    ...
    private void copyDataBase(byte[] response) throws IOException {
        ...
        String outFileName = ConstantsBikeRentalApp.DB_PATH + ConstantsBikeRentalApp.DB_NAME;
        ...
        SQLiteDBWork.checkDataBase(BikerentalApplication.getInstance());
    }
    ...
    private void copyDataBase() throws IOException{
        ...
        InputStream myInput = context.getAssets().open(ConstantsBikeRentalApp.DB_NAME);
